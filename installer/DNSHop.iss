...
#define PublishDir "..\artifacts\publish-win-x64-release"
...
AllowNoIcons=yes
OutputDir=.\output
; Derived from AppVersion so the installer file name can't drift out of sync with the version.
OutputBaseFilename=DNS-Hop-Setup-v{#AppVersion}
Compression=lzma
